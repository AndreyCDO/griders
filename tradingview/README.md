...
`griders_grid_dca_v29.pine` sends only `grid_dca_v2` signals for the current public GRID DCA 2.10 strategy.

Replace the old indicator on each chart with the GRID DCA 2.10 script and keep the alert condition as `Any alert() function call`.
